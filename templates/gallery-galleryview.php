...
/*!-----------------------------------------------------------------------------------
	...
	Find more galleryview options at http://brandonhubbard.com/GalleryView
...
<div id="<?php echo $gallery->anchor; ?>" class="galleryview">
  	...
  	<?php foreach ($images as $image) : ?>
	    <li class="<?php echo $image->pid; ?>"><img src="<?php echo apply_filters( 'jetpack_photon_url', $image->imageURL ); ?>" alt="<?php echo $image->alttext; ?>" data-description="<?php echo $image->description; ?>" title="<?php echo $image->alttext; ?>" <?php echo $image->size; ?>  /></li>
	<?php endforeach; ?>
  	</ul>
</div>
